          ...
          {MENU_ITEMS.map((item, index) => {
            ...
            return (
              <button
                ...
                className={`relative flex items-center justify-center w-full h-[56px] transition-transform duration-100 ${
                  isSelected 
                    ? "bg-[url('/images/button_highlighted.png')] scale-110 shadow-2xl" 
